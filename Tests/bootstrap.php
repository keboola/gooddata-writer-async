...
defined('GW_INVITATION_EMAIL') || define('GW_INVITATION_EMAIL', getenv('GW_INVITATION_EMAIL')? getenv('GW_INVITATION_EMAIL') : '');
defined('GW_INVITATION_PASSWORD') || define('GW_INVITATION_PASSWORD', getenv('GW_INVITATION_PASSWORD')? getenv('GW_INVITATION_PASSWORD') : '');
...
$paramsYaml = \Symfony\Component\Yaml\Yaml::dump([
    ...
    'parameters' => [
        ...
        'gdwr_invitations' => [
            'domain' => GW_GD_DOMAIN_NAME,
            'email' =>GW_INVITATION_EMAIL,
            'password' => GW_INVITATION_PASSWORD
        ],
